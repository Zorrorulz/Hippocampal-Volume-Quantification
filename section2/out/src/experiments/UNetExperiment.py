...
class UNetExperiment:
    ...
    def __init__(self, config, split, dataset):
        ...
        # Create data loaders
        # TASK: SlicesDataset class is not complete. Go to the file and complete it. - Completed
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: batch size, one hot vector (3 classes), image width, image height
