...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # To normalize, divided by the max value so the values are in 0 to 1 range.
        ...
        # ANSWER: Labels are discrete. Integers are more apt here. Also, It saves memory.
        # On the first label object the size went down from 499928 to 250028 by the cast to int
